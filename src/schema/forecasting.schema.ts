...
export const forecastSchema = z.object({
  ...
  numberOfTrips: z.number().int(),
  dtrRate: z.coerce.number().default(452.09),
  avgAccessorialPerTrip: z.coerce.number().default(70),
  revenuePerTrip: z.coerce.number(),
  weeklyRevenue: z.coerce.number(),
  monthlyRevenue: z.coerce.number(),
...
export const createForecastSchema = z.object({
  ...
  description: z.string().nullable().optional(),
  isDefault: z.boolean().default(false),
  numberOfTrips: z.number().int().min(1).default(7),
  dtrRate: z.coerce.number().min(0).default(452.09),
  avgAccessorialPerTrip: z.coerce.number().min(0).default(70),
});
...
export const updateForecastSchema = z.object({
  ...
  numberOfTrips: z.number().int().min(1).optional(),
  dtrRate: z.coerce.number().min(0).optional(),
  avgAccessorialPerTrip: z.coerce.number().min(0).optional(),
});
